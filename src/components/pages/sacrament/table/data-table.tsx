...
import AddFormSacrament from "../form/form";
...
export function DataTable({
  ...
  data: SacramentItem[];
  columns: ColumnDef<SacramentItem>[];
}) {
  const { cancelEdit, getSacrament, deleteSacrament, getSacraments } =
    sacramentStore();
  ...
  return (
    <div className="w-full relative">
      <div className="flex items-center py-4 justify-between">
        <h1 className="font-bold text-xl">Liste des sacraments</h1>
