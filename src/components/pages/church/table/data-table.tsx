...
import AddFormChurch from "../form/form";
...
export function DataTable({
  ...
  data: ChurchItem[];
  columns: ColumnDef<ChurchItem>[];
}) {
  const { cancelEdit, getChurch, deleteChurch, getChurchs } = churchStore();
  ...
  return (
    <div className="w-full relative">
      <div className="flex items-center py-4 justify-between">
        <h1 className="font-bold text-xl">Liste des églises</h1>
